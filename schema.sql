...
CREATE VIEW IF NOT EXISTS ALL_INFO AS
       ...
       FROM STUDENT
       LEFT JOIN ENROLLMENT ON STUDENT.nip = ENROLLMENT.nip
       LEFT JOIN SUBJECT ON ENROLLMENT.code = SUBJECT.code
       LEFT JOIN REGISTER ON STUDENT.nip = REGISTER.nip
       LEFT JOIN BACHELOR ON REGISTER.code = BACHELOR.code;
